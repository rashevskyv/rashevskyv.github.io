...
Натисніть на зображення вашого пристрою, щоб перейти до інструкції з його зламу. 
{: .notice}

Гайд по PS Vita поки в проєкті
{: .notice--warning}

Колір або ревізія вашого пристрою може відрізнятися від представленого на картинках і значення не має.
{: .notice--info}
